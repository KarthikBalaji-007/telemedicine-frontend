  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-6">
        ...
        {/* Main Problem Input Section - WITH UPLOAD BUTTON */}
            ...
            <form onSubmit={handleProblemSubmit} className="w-full">
              <div className="border-4 border-medical-red rounded-2xl bg-white overflow-hidden">
                <div className="flex items-center pl-16 pr-4 py-4">
                  ...
                  <label className="ml-2 w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white hover:bg-blue-700 transition-colors cursor-pointer">
                  ...
                  <button
                    ...
                    className="ml-2 w-12 h-12 bg-medical-red rounded-full flex items-center justify-center text-white hover:bg-red-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
        ...
        {/* Bottom Different Cards - EXACTLY AS BEFORE */}
