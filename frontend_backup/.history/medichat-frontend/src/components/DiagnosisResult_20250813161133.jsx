...
const DiagnosisResult = () => {
  ...
  const analyzeSymptoms = (symptomText) => {
    ...
    if (text.includes('cold') || text.includes('cough') || text.includes('sneez') || text.includes('common cold')) {
      return {
    ...
    if (text.includes('heart') || text.includes('chest')) {
      return {
        condition: "Heart Palpitations",
        probability: "65%",
        riskLevel: "Medium",
        riskColor: "bg-yellow-500",
        description: "Based on your heart-related concerns, there's a 65% chance of benign heart palpitations. These can be caused by stress, caffeine, or anxiety.",
        causes: "Common causes include stress, anxiety, caffeine intake, dehydration, or hormonal changes. Most palpitations are harmless but should be evaluated.",
        nextSteps: [
          "Reduce caffeine and alcohol intake",
          "Practice stress reduction techniques",
          "Stay hydrated and maintain regular sleep schedule",
          "Monitor episodes and triggers",
          "Seek immediate medical attention if accompanied by chest pain, shortness of breath, or dizziness",
          "Schedule a check-up with a cardiologist for proper evaluation"
        ]
      };
    }
