...
const HomePage = () => {
  ...
  // Different content for bottom cards to avoid repetition (but keeping original colors)
  const bottomCards = [
  ...
  return (
    <div className="min-h-screen bg-white p-6">
      ...
      {/* Top Symptom Cards Grid - Original Colors */}
      ...
      {/* Main Chat Input with Medical Emoji - Original Structure */}
      ...
      {/* Bottom Cards - Original Colors, Different Content */}
