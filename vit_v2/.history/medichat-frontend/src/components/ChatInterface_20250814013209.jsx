...
import { Stethoscope, Mic, Activity, Send, Upload, ArrowLeft, UserCheck } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="mb-6">
          <div className="relative">
            <input
              ...
              disabled={isLoading}
              className="w-full p-4 bg-gray-200 rounded-lg pr-64 focus:outline-none focus:ring-2 focus:ring-medical-red disabled:opacity-50"
            />
            <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex space-x-2">
              ...
              {/* Need Doctor Button - ADDED HERE IN RED */}
              <button
                type="button"
                onClick={() => navigate('/need-doctor')}
                className="bg-medical-red text-white px-4 py-2 rounded-full text-sm font-medium hover:bg-red-600 transition-colors flex items-center"
              >
