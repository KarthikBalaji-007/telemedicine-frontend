...
import { Stethoscope, Send, Upload, Plus, X, UserCheck, ChevronDown, Brain, Heart, Check, LogIn, UserPlus } from 'lucide-react';
...
const HomePage = () => {
  ...
  const modelOptions = [
    ...
    },
    {
      ...
      icon: '👶',
      color: 'text-pink-600',
      features: ['Pediatric Care', 'Growth Tracking', 'Vaccination', 'Child Development']
    }
  ];
  ...
  // Handle file upload functionality - FIXED TEMPLATE LITERAL
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-6">
        {/* Header - WITH LOGIN/REGISTER BUTTONS ADDED */}
        <div className="flex items-center justify-between mb-8">
          ...
          {/* LOGIN/REGISTER BUTTONS - ADDED HERE */}
          <div className="flex space-x-3">
            <button
              onClick={() => navigate('/login')}
              className="bg-black text-white px-6 py-2 rounded-full font-medium hover:bg-gray-800 transition-colors flex items-center"
            >
            ...
            <button
              ...
              className="bg-medical-red text-white px-6 py-2 rounded-full font-medium hover:bg-red-600 transition-colors flex items-center"
            >
                ...
                <form onSubmit={handleProblemSubmit} className="mt-6">
                  <div className="flex items-center bg-gray-200 rounded-lg p-3">
                    ...
                    <div className="flex items-center space-x-2 ml-4">
                      ...
                      {/* Upload Button - FIXED FILE ACCEPT */}
